...
public class Cruceros {
    ...
    public int hashCode() {
        ...
        hash = 71 * hash + Arrays.deepHashCode(this.destinos);
        hash = 71 * hash + (int) (Double.doubleToLongBits(this.precio) ^ (Double.doubleToLongBits(this.precio) >>> 32));
        hash = 71 * hash + this.numeroNoches;
        hash = 71 * hash + Objects.hashCode(this.puertoSalida);
        hash = 71 * hash + Objects.hashCode(this.buque);
        return hash;
    }
    ...
    public String toString() {
        return "Cruceros{" + "nombre=" + nombre + ", destinos=" + destinos + ", precio=" + precio + ", numeroNoches=" + numeroNoches + ", puertoSalida=" + puertoSalida + ", buque=" + buque + '}';
    }
}
